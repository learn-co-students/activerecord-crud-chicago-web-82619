...
def can_be_created_in_a_block(arg = {title: "Home Alone", release_date: "1990"})
  ...
  Movie.create do |t|
      t.title = arg[:title]
      t.release_date = arg[:release_date]
  end
end
...
def can_find_by_multiple_attributes
  ...
  # release_date == 2000
  # director == "Me"
  Movie.all.where(title:"Title", release_date: "2000", director: "Me").first
end
...
def can_be_found_updated_and_saved
  ...
  movie1 = Movie.create(title: "Awesome Flick")
  movie1 = Movie.find_by(title: "Awesome Flick")
  movie1.update(title: "Even Awesomer Flick")
  movie1.save
end
...
def can_update_multiple_items_at_once
  # Change title of all movies to "A Movie"n
  5.times do |i|
